docker tag udagram-api-feed hothanhnhank1c/udagram-api-feed:v8
docker tag udagram-api-user hothanhnhank1c/udagram-api-user:v8
docker tag reverseproxy hothanhnhank1c/reverseproxy:v8
docker tag udagram-frontend hothanhnhank1c/udagram-frontend:v8

docker push hothanhnhank1c/udagram-api-feed:v8
docker push hothanhnhank1c/udagram-api-user:v8
docker push hothanhnhank1c/reverseproxy:v8
docker push hothanhnhank1c/udagram-frontend:v8
